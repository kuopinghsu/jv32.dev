...
`endif
                ...
                OPCODE_JAL:  begin jal = 1'b1; reg_we = 1'b1; end
                OPCODE_JALR: begin jalr = 1'b1; reg_we = 1'b1; alu_src = 1'b1;
                                   if (funct3 != 3'b000) illegal = 1'b1; end
                OPCODE_LUI:  begin lui = 1'b1; reg_we = 1'b1; end
                OPCODE_AUIPC:begin auipc = 1'b1; alu_src = 1'b1; reg_we = 1'b1; end
