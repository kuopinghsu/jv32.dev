...
#define configMTIME_BASE_ADDRESS                ( 0x02004000UL )  /* JV32 CLIC mtime @ JV_CLIC_BASE+0x4000 */
#define configMTIMECMP_BASE_ADDRESS             ( 0x02004008UL )  /* JV32 CLIC mtimecmp @ JV_CLIC_BASE+0x4008 */
