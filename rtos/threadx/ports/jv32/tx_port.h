...
/* Trace timestamp source: use CLINT mtime low word (or 0 if not available). */
...
/* Minimum stack: 65 words (260 bytes) with FP, 31 words (124 bytes) without,
 * plus headroom for nested function calls and ISR trap frame (144 bytes). */
...
#ifndef TX_JV32_CLINT_CYCLES_PER_TICK
#define TX_JV32_CLINT_CYCLES_PER_TICK  100000ULL
#endif

#define TX_INT_DISABLE                 0x00000000u
#define TX_INT_ENABLE                  0x00000008u
