...
module axi_ram_ctrl #(
    ...
    always_ff @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            if ((aw_active || (s_awvalid && s_awready)) &&
                (w_active  || (s_wvalid  && s_wready))) begin
    ...
    assign do_write = WR_EN &&
                      (aw_active || (s_awvalid && !aw_active)) &&
                      (w_active  || (s_wvalid  && !w_active));
    ...
    // Suppress unused
    logic _unused; assign _unused = &{1'b0, rst_n};
